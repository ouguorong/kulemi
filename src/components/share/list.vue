	...
	<div class='phone_game'>
		<div class='phone_game_left'>
			...
			<div class='phone_game_left_main'>
				<ul>
					<li :class='{removeLeft:index1==i||index2==i||index3==i}' v-for='(item,i) in gameListLeft' :key='item.id'>
		...
		<div class='phone_game_right'>
			...
			<div>
				<ul>
					<li v-for='(item,i) in gameListRigh' :key='item.id'>
						<p>
...
<script>
	export default{
		...
		props:["titleLeft","titleRight","lists","gameListLeft","gameListRigh"]
	}
</script>
